...
### PD-001: 优先采用进程外插件，不使用 Go plugin 原生机制
...
### PD-006: 插件配置统一通过 Runtime config.json 管理
...
### PD-008: 插件通信协议默认 gRPC over Unix Socket
