...
```bash
# 命令行参数覆盖
yaa --runtime.api.http.addr "127.0.0.1:7070"
# 最终 addr = "127.0.0.1:7070"（覆盖配置文件的 "127.0.0.1:9090"）
```
...
|--------|-----------|----------|-------------|-----------|-----------|
| `runtime.api.http.addr` | `127.0.0.1:8080` | `127.0.0.1:9090` | — | `127.0.0.1:7070` | `127.0.0.1:7070` |
